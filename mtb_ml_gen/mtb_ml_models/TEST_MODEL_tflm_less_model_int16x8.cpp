...
constexpr int kTensorArenaSize = 3666;
...
const TfArray<1, float> quant0_scale = { 1, { 0.0077822199091315269, } };
const TfArray<1, int> quant0_zero = { 1, { 0, } };
const TfLiteAffineQuantization quant0 = { (TfLiteFloatArray*)&quant0_scale, (TfLiteIntArray*)&quant0_zero, 0 };
const ALIGN(8) int64_t tensor_data1[16] = { 
    -3207, 11652, 7030, -515, -69, -2857, -1011, 193, -649, 12385, 
    -2743, -20, -729, -16, -3952, -2147, 
};
const TfArray<1, int> tensor_dimension1 = { 1, { 16, } };
const TfArray<1, float> quant1_scale = { 1, { 5.4153835662873462e-05, } };
const TfArray<1, int> quant1_zero = { 1, { 0, } };
const TfLiteAffineQuantization quant1 = { (TfLiteFloatArray*)&quant1_scale, (TfLiteIntArray*)&quant1_zero, 0 };
const ALIGN(8) int64_t tensor_data2[10] = { 
    -20469, -28251, -7039, 11297, -13475, 17120, -8173, -21901, 34089, -9541, 
};
const TfArray<1, int> tensor_dimension2 = { 1, { 10, } };
const TfArray<1, float> quant2_scale = { 1, { 2.4669863705639727e-05, } };
const TfArray<1, int> quant2_zero = { 1, { 0, } };
const TfLiteAffineQuantization quant2 = { (TfLiteFloatArray*)&quant2_scale, (TfLiteIntArray*)&quant2_zero, 0 };
const ALIGN(8) int64_t tensor_data3[16] = { 
    -2211, -1929, -1956, -2541, -1110, -2874, -1418, -1657, -2572, -239, 
    -2640, -1089, -1233, -1686, -643, -10067, 
};
const TfArray<1, int> tensor_dimension3 = { 1, { 16, } };
const TfArray<1, float> quant3_scale = { 1, { 1.3146465789759532e-05, } };
const TfArray<1, int> quant3_zero = { 1, { 0, } };
const TfLiteAffineQuantization quant3 = { (TfLiteFloatArray*)&quant3_scale, (TfLiteIntArray*)&quant3_zero, 0 };
const ALIGN(8) int8_t tensor_data4[16*784] = { 
...
const TfArray<2, int> tensor_dimension4 = { 2, { 16, 784, } };
const TfArray<1, float> quant4_scale = { 1, { 0.0016892950516194105, } };
...
const TfArray<1, float> quant5_scale = { 1, { 0.0039675491861999035, } };
const TfArray<1, int> quant5_zero = { 1, { 0, } };
const TfLiteAffineQuantization quant5 = { (TfLiteFloatArray*)&quant5_scale, (TfLiteIntArray*)&quant5_zero, 0 };
const ALIGN(8) int8_t tensor_data6[10*16] = { 
...
const TfArray<2, int> tensor_dimension6 = { 2, { 10, 16, } };
const TfArray<1, float> quant6_scale = { 1, { 0.0052004586905241013, } };
const TfArray<1, int> quant6_zero = { 1, { 0, } };
const TfLiteAffineQuantization quant6 = { (TfLiteFloatArray*)&quant6_scale, (TfLiteIntArray*)&quant6_zero, 0 };
const TfArray<2, int> tensor_dimension7 = { 2, { 1, 16, } };
const TfArray<1, float> quant7_scale = { 1, { 0.013649190776050091, } };
const TfArray<1, int> quant7_zero = { 1, { 0, } };
const TfLiteAffineQuantization quant7 = { (TfLiteFloatArray*)&quant7_scale, (TfLiteIntArray*)&quant7_zero, 0 };
const TfArray<2, int> tensor_dimension8 = { 2, { 1, 16, } };
const TfArray<1, float> quant8_scale = { 1, { 0.0047437860630452633, } };
const TfArray<1, int> quant8_zero = { 1, { 0, } };
const TfLiteAffineQuantization quant8 = { (TfLiteFloatArray*)&quant8_scale, (TfLiteIntArray*)&quant8_zero, 0 };
const TfArray<2, int> tensor_dimension9 = { 2, { 1, 10, } };
const TfArray<1, float> quant9_scale = { 1, { 0.003922079224139452, } };
const TfArray<1, int> quant9_zero = { 1, { 0, } };
const TfLiteAffineQuantization quant9 = { (TfLiteFloatArray*)&quant9_scale, (TfLiteIntArray*)&quant9_zero, 0 };
const TfArray<2, int> tensor_dimension10 = { 2, { 1, 10, } };
const TfArray<1, float> quant10_scale = { 1, { 3.0517578125e-05, } };
const TfArray<1, int> quant10_zero = { 1, { 0, } };
const TfLiteAffineQuantization quant10 = { (TfLiteFloatArray*)&quant10_scale, (TfLiteIntArray*)&quant10_zero, 0 };
const TfLiteFullyConnectedParams opdata0 = { kTfLiteActRelu, kTfLiteFullyConnectedWeightsFormatDefault, 0, 0, (TfLiteType)4 };
const TfArray<3, int> inputs0 = { 3, { 0, 4, 3, } };
const TfArray<1, int> outputs0 = { 1, { 7, } };
const TfLiteFullyConnectedParams opdata1 = { kTfLiteActRelu, kTfLiteFullyConnectedWeightsFormatDefault, 0, 0, (TfLiteType)4 };
const TfArray<3, int> inputs1 = { 3, { 7, 5, 1, } };
const TfArray<1, int> outputs1 = { 1, { 8, } };
const TfLiteFullyConnectedParams opdata2 = { kTfLiteActNone, kTfLiteFullyConnectedWeightsFormatDefault, 0, 0, (TfLiteType)4 };
...
const TensorInfo_t tensorData[] = {
  { kTfLiteInt16, tensor_arena + 0, (TfLiteIntArray*)&tensor_dimension0, 1568, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant0)) },},
  { kTfLiteInt64, (void*)tensor_data1, (TfLiteIntArray*)&tensor_dimension1, 128, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant1)) },},
  { kTfLiteInt64, (void*)tensor_data2, (TfLiteIntArray*)&tensor_dimension2, 80, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant2)) },},
  { kTfLiteInt64, (void*)tensor_data3, (TfLiteIntArray*)&tensor_dimension3, 128, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant3)) },},
  { kTfLiteInt8, (void*)tensor_data4, (TfLiteIntArray*)&tensor_dimension4, 12544, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant4)) },},
  ...
  { kTfLiteInt8, (void*)tensor_data6, (TfLiteIntArray*)&tensor_dimension6, 160, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant6)) },},
  { kTfLiteInt16, tensor_arena + 1568, (TfLiteIntArray*)&tensor_dimension7, 32, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant7)) },},
  { kTfLiteInt16, tensor_arena + 0, (TfLiteIntArray*)&tensor_dimension8, 32, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant8)) },},
  { kTfLiteInt16, tensor_arena + 32, (TfLiteIntArray*)&tensor_dimension9, 20, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant9)) },},
  { kTfLiteInt16, tensor_arena + 0, (TfLiteIntArray*)&tensor_dimension10, 20, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant10)) },},
};
...
OpData TEST_MODEL_op_user_data[] = {
  {{2118029155, -10, 0, 32767, -1, 0, 0, 0, 0, nullptr, nullptr, false}, TEST_MODEL_op_user_data0_per_channel_output_multiplier, TEST_MODEL_op_user_data0_per_channel_output_shift, -1, TEST_MODEL_op_user_data0_kernel_sums, 1, 784, 16, nullptr, -1, -1, EvalQuantizedInt16}, 
  {{1568967572, -6, 0, 32767, -1, 0, 0, 0, 0, nullptr, nullptr, false}, TEST_MODEL_op_user_data1_per_channel_output_multiplier, TEST_MODEL_op_user_data1_per_channel_output_shift, -1, TEST_MODEL_op_user_data1_kernel_sums, 1, 16, 16, nullptr, -1, -1, EvalQuantizedInt16}, 
  {{1728981010, -7, -32768, 32767, -1, 0, 0, 0, 0, nullptr, nullptr, false}, TEST_MODEL_op_user_data2_per_channel_output_multiplier, TEST_MODEL_op_user_data2_per_channel_output_shift, -1, TEST_MODEL_op_user_data2_kernel_sums, 1, 16, 10, nullptr, -1, -1, EvalQuantizedInt16}
};
} // namespace fully_connected
